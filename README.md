...
- **Коммерческий проект** (Сентябрь 2025 – настоящее время): Разработка монитора web-уязвимостей из источников ФСТЭК, CVE, Exploit-DB, Nuclei с помощью фреймворка userver. Работал в команде с PR через Git.
