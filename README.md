...
- **Коммерческий проект** (Сентябрь 2025 – Ноябрь 2025): Разработка монитора web-уязвимостей из источников ФСТЭК, CVE, Exploit-DB, Nuclei с помощью фреймворка userver с последующим уведомлением в Tg и постановкой задачи на обработку уязвимости в Yandex Traker. Работал в команде с PR через Git.
